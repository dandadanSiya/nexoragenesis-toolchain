...
STRINGS = [
    ...
    ("HELP_TXT", "help ps mem uptime clear echo spin crash clavier nova reboot"),
    ("SPAWNED", "nouvelle tache spinner creee"),
    ("CRASHER", "crash"),
    ("CRASHMSG", "tache creee: elle va deborder sa pile (page de garde)"),
    ("LAYOUT_AZ", "clavier AZERTY"),
    ("LAYOUT_QW", "clavier QWERTY"),
    ("NOVA_HELLO", "Bonjour depuis un programme Nova, calcul = "),
    ("NOVA_RUN", "lancement du programme Nova..."),
    ("OVERFLOW", "debordement de pile - tache tuee: "),
]
