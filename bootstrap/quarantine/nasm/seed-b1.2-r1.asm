...
; Quarantaine temporaire autorisée pour le tracer B1.2 uniquement.
; Commande de matérialisation quarantainée :
; nasm -f bin bootstrap/quarantine/nasm/seed-b1.2-r1.asm -o bootstrap/quarantine/nasm/out/seed-b1.2-r1.efi
...
text_end:
    %if (text_end - text_start) > 0x1200
        %error "B1.2 .text depasse 0x1200"
    %endif
    times 0x1200 - ($ - $$) db 0
...
diagnostic_template:
    ...
    times 0x110 - ($ - $$) db 0
success_b12:
    ; NG_B1_2_PHYSICAL_OK\r\n — unique succès des 24 oracles physiques.
    dw 'N','G','_','B','1','_','2','_','P','H','Y','S','I','C','A','L','_','O','K',13,10,0
