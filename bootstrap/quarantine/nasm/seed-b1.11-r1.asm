...
; Quarantaine temporaire autorisée pour le tracer B1.11 uniquement.
; Commande de matérialisation quarantainée :
; nasm -f bin bootstrap/quarantine/nasm/seed-b1.11-r1.asm -o bootstrap/quarantine/nasm/out/seed-b1.11-r1.efi
...
success_b111:
    ...
    dw 'N','G','_','S','0','_','T','1','1','_','O','K',13,10,0
abi_kw:
    db 'abi'
efi_x64_kw:
    db 'efi_x64'
