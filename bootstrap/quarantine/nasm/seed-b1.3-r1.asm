...
; Quarantaine temporaire autorisée pour le tracer B1.3 uniquement.
; Commande de matérialisation quarantainée :
; nasm -f bin bootstrap/quarantine/nasm/seed-b1.3-r1.asm -o bootstrap/quarantine/nasm/out/seed-b1.3-r1.efi
...
text_end:
    %if (text_end - text_start) > 0x1200
        %error "B1.3 .text depasse 0x1200"
    %endif
    times 0x1200 - ($ - $$) db 0
...
diagnostic_template:
    ...
    times 0x110 - ($ - $$) db 0
success_b13:
    ; NG_S0_T03_OK\r\n — succès temporaire du tracer B1.3.
    dw 'N','G','_','S','0','_','T','0','3','_','O','K',13,10,0
abi_kw:
    db 'abi'
efi_x64_kw:
    db 'efi_x64'
